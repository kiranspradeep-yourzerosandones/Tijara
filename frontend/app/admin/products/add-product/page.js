...
export default function AddProduct() {
      ...
      {previewImage && (
        ...
        >
          ...
          >
            <button
              onClick={() => setPreviewImage(null)}
              className="absolute -top-4 -right-4 z-10 w-10 h-10 bg-white/90 backdrop-blur text-gray-700 
                         rounded-full flex items-center justify-center shadow-2xl hover:bg-white 
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="hidden sm:inline-flex px-2 py-0.5 bg-amber-100 text-amber-700 text-[10px] font-bold uppercase tracking-wider rounded-full">
                    Draft
                  </span>
                </div>
                ...
                <div className="p-6 space-y-5">
                  ...
                  <div className="group">
                    ...
                    <input
                      ...
                      placeholder="e.g. Premium Industrial Adhesive 500ml"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div ref={categoryRef} className="relative">
                      ...
                      {showCategoryDropdown && (
                        <div
                          className="absolute z-30 w-full mt-2 bg-white border border-gray-200 rounded-xl 
                                        shadow-xl shadow-gray-200/50 max-h-52 overflow-y-auto 
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder="Brief product summary that appears in search results and cards..."
                      rows="3"
                      maxLength={200}
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl 
                                 focus:ring-2 focus:ring-amber-400/30 focus:border-amber-400 focus:bg-white
                ...
                <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">
                        Rich descriptions and product specs
                      </p>
                    </div>
                  </div>
                </div>
                <div className="p-6 space-y-5">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="w-full text-left border border-gray-200 rounded-xl hover:border-amber-400 
                                 transition-all duration-200 group overflow-hidden hover:shadow-md hover:shadow-amber-100/50"
                    >
                      {formData.description ? (
                        <div className="px-5 py-4 max-h-28 overflow-hidden relative">
                          <div
                            className="text-gray-600 text-sm leading-relaxed line-clamp-3 prose prose-sm"
                        ...
                        <div className="px-5 py-8 flex flex-col items-center gap-3 text-gray-400 group-hover:text-amber-500 transition-colors">
                          ...
                          <span className="text-sm font-medium">
                            Click to write rich description
                          </span>
                          <span className="text-xs text-gray-400">
                            Supports headings, lists, bold, links & more
                          </span>
                        </div>
                      )}
                      <div className="px-5 py-2.5 bg-gray-50/80 border-t border-gray-100 flex items-center justify-between">
                        <span className="text-xs text-gray-400 font-mono">
                          {formData.description
                            ? `${stripHtml(formData.description).length} characters`
                            : "No content yet"}
                        </span>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="e.g. Adhesives, Laminates, Coatings"
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl 
                                 focus:ring-2 focus:ring-amber-400/30 focus:border-amber-400 focus:bg-white
                                 text-gray-900 placeholder:text-gray-400 transition-all duration-200
                                 hover:border-gray-300"
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-2.5">
                        {formData.applications
                          ...
                          .map((app, i) => (
                            <span
                              key={i}
                              className="inline-flex items-center px-2.5 py-1 bg-blue-50 text-blue-700 
                      ...
                      {formData.storage ? (
                        ...
                        <div className="px-5 py-5 flex items-center gap-3 text-gray-400 group-hover:text-amber-500 transition-colors">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-400">
                              Temperature, handling, shelf life...
                            </p>
                          </div>
                        </div>
                      )}
                ...
                <div className="p-5">
                  {imagePreviews.length > 0 && (
                    <div className="grid grid-cols-3 sm:grid-cols-5 xl:grid-cols-3 gap-3 mb-4">
                      {imagePreviews.map((preview, index) => (
                        <div
                          key={index}
                          className="relative aspect-square group cursor-pointer rounded-xl overflow-hidden ring-1 ring-gray-200"
                        ...
                        >
                          ...
                          <button
                            ...
                            className="absolute top-1.5 right-1.5 w-6 h-6 bg-red-500/90 backdrop-blur text-white 
                          ...
                          {index === 0 && (
                            <span
                              className="absolute bottom-1.5 left-1.5 px-2 py-0.5 bg-amber-400/90 backdrop-blur 
                                            text-gray-900 text-[10px] font-bold rounded-md tracking-wide"
                            >
                              COVER
                            </span>
                          )}
                  ...
                  {imagePreviews.length < 5 && (
                    <label
                      ...
                      onDrop={handleDrop}
                      className={`block border-2 border-dashed rounded-xl transition-all duration-200 cursor-pointer
                                  ${
                                    dragActive
                                      ? "border-amber-400 bg-amber-50 scale-[1.02]"
                                      : "border-gray-200 hover:border-amber-400 hover:bg-amber-50/30"
                                  }
                                  ${imagePreviews.length > 0 ? "p-5" : "p-10"}`}
                    >
                      <input
                        type="file"
                        multiple
                      ...
                      <div className="flex flex-col items-center gap-3 text-gray-400">
                        <div
                          className={`${
                            imagePreviews.length > 0
                              ? "w-10 h-10"
                              : "w-14 h-14"
                          } rounded-xl bg-gray-100 flex items-center justify-center transition-colors
                                        ${
                                          dragActive
                        ...
                        >
                          <svg
                            className={`${
                              imagePreviews.length > 0 ? "w-5 h-5" : "w-7 h-7"
                            }`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <div className="flex-1 relative">
                        ...
                        <input
                          ...
                          className="w-full pl-8 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl 
                                     focus:ring-2 focus:ring-amber-400/30 focus:border-amber-400 focus:bg-white
                                     text-gray-900 font-semibold text-lg placeholder:text-gray-300 
                      ...
                      <select
                        ...
                        value={formData.unit}
                        onChange={handleChange}
                        className="w-24 px-3 py-3 bg-gray-50 border border-gray-200 rounded-xl 
                                   focus:ring-2 focus:ring-amber-400/30 focus:border-amber-400 
                                   text-gray-700 text-sm font-medium cursor-pointer transition-all duration-200
                                   hover:border-gray-300"
                      >
                        {units.map((u) => (
  ...
  <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
    <div className="flex items-center gap-2.5">
      ...
      <div>
        ...
        <p className="text-xs text-gray-400">
          Stock and order quantity settings
        </p>
      </div>
    </div>
  </div>
  <div className="p-6 space-y-5">
    ...
    <div className="grid grid-cols-2 gap-4 mb-2">
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl 
                     focus:ring-2 focus:ring-amber-400/30 focus:border-amber-400 focus:bg-white
                     text-gray-900 font-medium transition-all duration-200 hover:border-gray-300"
        />
      </div>
      <div>
        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
      ...
      >
        <div className="flex items-center gap-3">
          <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${
            formData.trackQuantity ? "bg-indigo-100" : "bg-gray-100"
          }`}>
            <svg
              className={`w-5 h-5 ${formData.trackQuantity ? "text-indigo-600" : "text-gray-400"}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              {formData.trackQuantity 
                ? "Stock will be tracked and decremented on orders" 
                : "No stock tracking - use manual In Stock toggle"}
            </p>
          </div>
        </div>
        <div className="relative flex-shrink-0">
          ...
          />
          <div
            className="w-12 h-6 bg-gray-200 peer-checked:bg-indigo-500 rounded-full 
                       transition-colors duration-300 after:content-[''] after:absolute 
                       after:top-0.5 after:left-0.5 after:w-5 after:h-5 after:bg-white 
                       after:rounded-full after:shadow-sm after:transition-transform after:duration-300 
                       peer-checked:after:translate-x-6"
          />
        </div>
      </label>

      {/* Stock Quantity Input - Shows when tracking is enabled */}
      {formData.trackQuantity && (
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg 
                           ...
                           text-gray-900 font-semibold text-lg transition-all duration-200"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-500 mb-1.5">
    ...
    {/* In Stock Toggle - Only shows when NOT tracking quantity */}
    {!formData.trackQuantity && (
      <label
        className={`flex items-center justify-between py-4 px-5 rounded-xl cursor-pointer 
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className={`w-3 h-3 rounded-full ring-4 transition-all duration-200 ${
              formData.inStock
        ...
        <div className="relative flex-shrink-0">
          ...
          />
          <div
            className="w-12 h-6 bg-gray-200 peer-checked:bg-emerald-500 rounded-full 
                       transition-colors duration-300 after:content-[''] after:absolute 
                       after:top-0.5 after:left-0.5 after:w-5 after:h-5 after:bg-white 
                       after:rounded-full after:shadow-sm after:transition-transform after:duration-300 
                       peer-checked:after:translate-x-6"
          ...
          <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
            ...
            {parseInt(formData.stockQuantity) <= 0 ? (
              ...
              <svg className={`w-5 h-5 ${
                parseInt(formData.stockQuantity) <= parseInt(formData.lowStockThreshold || 10) ? "text-amber-600" : "text-emerald-600"
