        ...
        <div className="relative z-10 flex flex-col justify-center h-full px-12 xl:px-16">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-3">
              <div className="relative h-19 w-46 ml-[-15%]">
                <Image
                  src="/images/tijarawhite.png"
                  alt="Tijara"
                  fill
            ...
            <p className="text-[9px] text-gray-500 font-semibold uppercase tracking-widest mt-1.5">
              Administration
            </p>
          </div>
          ...
          <div className="max-w-md">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-8">
              Access the complete suite of tools to manage products, orders,
