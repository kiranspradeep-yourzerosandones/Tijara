              ...
              <label className="flex items-center cursor-pointer group">
                <div className="relative">
                  ...
                  <div className="w-4 h-4 bg-gray-800 border border-gray-600 rounded 
                                  ...
                                  group-hover:border-gray-500 transition-all"></div>
                  <svg className="absolute top-0.5 left-0.5 w-3 h-3 text-gray-900 opacity-0 peer-checked:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
