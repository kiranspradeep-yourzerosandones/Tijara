...
export default function EditAdminPage() {
  ...
  const fetchAdmin = async () => {
    try {
      const response = await fetch(`${API_URL}/admin/admins/${params.id}`, {
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    <input
                      ...
                      onChange={handleChange}
                      disabled={formData._id === currentAdmin?._id}
                    ...
                    <div
                      className="w-12 h-6 bg-gray-200 peer-checked:bg-emerald-500 rounded-full 
                                    ...
                                    peer-checked:after:translate-x-6 peer-disabled:opacity-50"
                    />
                  </div>
                </label>
                {formData._id === currentAdmin?._id && (
              ...
              <div className="p-6">
                <div
                  className={`grid grid-cols-1 sm:grid-cols-3 gap-3 ${
                    formData._id === currentAdmin?._id ? "opacity-60 pointer-events-none" : ""
                  }`}
                >
                  {[
                    {
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <span
                          className={`text-sm font-semibold ${
                            formData.role === role.value ? role.textColor : "text-gray-900"
                          }`}
                        >
                          {role.label}
                        </span>
                        <div
                          className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors ${
                            formData.role === role.value
                              ? `${role.borderColor.replace("border", "bg")} border-transparent`
                              : "border-gray-300"
                          }`}
                        >
                          {formData.role === role.value && (
                    ...
                    <div className="bg-purple-50 border border-purple-200/60 rounded-xl p-5 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-purple-600 mt-1">
                          Super Admins automatically have all permissions enabled
                        </p>
                      </div>
                    </div>
                  ) : (
              ...
              <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden">
                ...
                <div className="p-5 space-y-3 text-sm">
                  ...
                  <div className="flex items-center justify-between py-2.5">
                    ...
                    <span className="text-gray-700 font-medium">
                      {formatDate(formData.lastLoginAt)}
                    </span>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-700 text-sm leading-relaxed">
                        You can update your name, email, and phone. Role and status 
                        changes require another admin.
                      </p>
                    </div>
                  </div>
                </div>
