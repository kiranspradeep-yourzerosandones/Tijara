...
export default function AdminsPage() {
  ...
  const handleDeleteAdmin = async (adminId, adminName) => {
    const ok = await confirm({
      title: "Delete Admin",
      message:
        "This action cannot be undone. The admin account will be permanently removed and they will immediately lose all access.",
      details: adminName,
    ...
    setActionLoading(adminId);
    try {
      const data = await adminAPI.delete(adminId);
      if (data.success) {
        fetchAdmins();
      } else {
        setError(data.message);
        ...
        <div className="sticky top-0 z-30 -mx-6 px-6 bg-white/80 backdrop-blur-xl border-b border-gray-200/80">
          <div className="flex items-center justify-between py-4 max-w-[1600px] mx-auto">
            ...
            <Link
              ...
              className="group relative px-5 sm:px-6 py-2.5 font-semibold text-sm 
                         transition-all duration-200 flex items-center gap-2 rounded-xl 
                         overflow-hidden bg-gray-900 hover:bg-gray-800 text-white 
                         shadow-lg shadow-gray-900/20 hover:shadow-xl 
                         hover:shadow-gray-900/30 active:scale-[0.98]"
            >
              <svg
          ...
          <div className="mt-6 max-w-[1600px] mx-auto">
            <div
              className="p-4 bg-red-50 border border-red-200/60 text-red-800 
                          flex items-center gap-3 text-sm rounded-2xl 
                  ...
                  >
                    <path
                      ...
                      d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7
                         ...
                         0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-4 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            <span
                              className={`inline-flex px-2.5 py-0.5 text-xs font-semibold capitalize rounded-lg border ${getRoleBadge(a.role)}`}
                            >
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0">
                        ...
                        {/* Toggle + Delete — hidden for self */}
                        {a.id !== admin?.id && (
                          <>
                            {/* Toggle Status */}
                            <button
                              onClick={() =>
                                handleToggleStatus(a.id, a.isActive, a.name)
                              }
