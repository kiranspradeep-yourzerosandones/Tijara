...
// ============================================================
// 1. ESSENTIAL BODY PARSERS & CORS (Must be at the very top)
// ============================================================
...
// ============================================================
// 2. SECURITY MIDDLEWARE (After body parsers)
// ============================================================
app.use(
  helmet({
...
// ── Direct Account Deletion Route Handler (Guaranteed Top Match) ──
const authController = require("./controllers/authController");
const { protect } = require("./middleware/auth");

app.delete("/api/auth/delete-account", protect, authController.deleteAccount);
app.post("/api/auth/delete-account", protect, authController.deleteAccount);
